            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table id="zero_config" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <?php
                    $products = $shopFacade->fetchProducts()->fetchAll();
                    foreach($products as $product) { ?>
                    <tr>
                      <td><img src="<?= '../' . $product["image"] ?>" alt="Image" style="height: 100px"></td>
                      <td><?= $product["name"] ?></td>
                      <td><?= $product["price"] ?></td>
                      <td><?= $product["link"] ?></td>
                      <td>
                        <a href="update-product.php?product_id=<?= $product["id"] ?>" class="btn btn-primary">Update</a>
                        <a href="delete-product.php?product_id=<?= $product["id"] ?>&image=<?= $product["image"] ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>

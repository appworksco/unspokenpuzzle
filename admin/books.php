    ...
    <div class="scroll-sidebar">
      <nav class="sidebar-nav">
        <ul id="sidebarnav" class="p-t-30">
          ...
          <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="news.php" aria-expanded="false"><i class="mdi mdi-earth"></i><span class="hide-menu">News</span></a></li>
                    ...
                    <div class="row">
                      <div class="col-lg-8">
                        <div class="d-flex align-items-center">
                          <img src="<?= '../' . $book["book_image"] ?>" alt="Book Image" style="height: 100px">
                          <div class="d-block p-3">
                            <?= $book["book_name"] ?><br>
                            <?php
                            $fetchNumberOfChapterByBookId = $chapterFacade->fetchNumberOfChapterByBookId($bookId);
                            echo $fetchNumberOfChapterByBookId . ' Chapters';
                            ?>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-4 d-flex align-items-center justify-content-center">
                        <div class="btn-group">
                          <button type="button" class="btn btn-secondary btn-lg w-100">Continue Writing</button>
                          <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" id="dropdownMenuReference" data-bs-toggle="dropdown" aria-expanded="false" data-bs-reference="parent">
                            <span class="visually-hidden">Toggle Dropdown</span>
                          </button>
                          <ul class="dropdown-menu p-2" aria-labelledby="dropdownMenuReference">
                            <li><a href="continue.php?book_id=<?= $book["id"] ?>" class="btn btn-primary w-100">Update</a></li>
                            <li><a href="delete-book.php?book_id=<?= $book["id"] ?>&book_image=<?= $book["book_image"] ?>" class="btn btn-danger w-100">Delete</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
